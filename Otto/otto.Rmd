...
```{r}
train <- read.csv("C:/Users/Willy/OneDrive/公用/台大/Senior courses/Second semester/Statistical Learning/R/Otto/data/train.csv", na.strings = "")
test <- read.csv("C:/Users/Willy/OneDrive/公用/台大/Senior courses/Second semester/Statistical Learning/R/Otto/data/test.csv", na.strings = "")
```
...
rf <- randomForest(train[,c(-1,-95)], as.factor(train$target), ntree=600, mtry = 20)
...
extra <- extraTrees(train[,c(-1,-95)], as.factor(train$target), mtry = 20, ntree=800, nodesize = 1, numThreads = 2)
